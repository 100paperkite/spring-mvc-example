package com.example.mvc.web.basic;

import com.example.mvc.domain.Item;
import com.example.mvc.domain.ItemRepository;
...
public class BasicItemController {
    ...
    public String edit(@PathVariable Long itemId, @ModelAttribute Item item) {
        ItemParamDto dto = new ItemParamDto(item.getItemName(), item.getPrice(), item.getQuantity());
